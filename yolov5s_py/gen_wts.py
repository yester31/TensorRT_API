...
def parse_args():
    ...
    parser.add_argument('-w', '--weights', default='yolov5s.pt')
...
model.model[-1].register_buffer('anchor_grid0', anchor_grid[0, :, :])
model.model[-1].register_buffer('anchor_grid1', anchor_grid[1, :, :])
model.model[-1].register_buffer('anchor_grid2', anchor_grid[2, :, :])
